...
function Cart() {
  ...
  // cart.find(cartItem => pizzas.find(item => item.id == cartItem.id))
          ...
          <div className="cart__top">
            <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                ...
                <path
                  ...
                  stroke="white" strokeWidth="1.8" strokeLinecap="round" strikeLinejoin="round" />
                <path
            ...
            <div className="cart__clear">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  stroke="#B6B6B6" strokeWidth="1.2" strokeLinecap="round" strikeLinejoin="round" />
